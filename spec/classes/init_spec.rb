  ...
  context 'on a RedHat system' do
    ...
    context 'with domains => set, sections => default' do
      ...
      it do
        ...
        should_not contain_class('sssd::homedir')
    ...
    context 'with domains => set, sections => default, manage_cron => false' do
      let :params do
        {
          :domains       => [ 'mydomain.com' ],
          :manage_cron   => false,
      ...
      it do
        ...
        should_not contain_service('crond')
      end
    end
  end
  ...
  context 'on a Debian system' do
    ...
    context 'with domains => set, sections => default' do
      ...
      it do
        ...
        should contain_exec('authconfig-sssd').with_command('/bin/true')
        should contain_service('sssd').with(
        'ensure' => 'running',
        'enable' => 'true',
        ).that_subscribes_to('Exec[authconfig-sssd]')
        should contain_service('cron').that_subscribes_to('Service[sssd]')
      end
    end
    ...
    context 'with domains => set, sections => default, manage_cron => false' do
      ...
      it do
        ...
        should_not contain_service('cron')
      end
    end
